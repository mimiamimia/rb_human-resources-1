                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed space-y-10">
                            Contratar a nossa empresa de RH é uma decisão inteligente para qualquer negócio que deseja crescer e se destacar no mercado. Nós oferecemos soluções personalizadas e eficientes para recrutamento, seleção, treinamento e desenvolvimento de equipes, garantindo que sua empresa conte com os melhores talentos. Nosso compromisso é entender as necessidades específicas do seu negócio e oferecer um serviço de alta qualidade, com ética, transparência e respeito. Além disso, nossa experiência e dedicação ajudam a otimizar processos, reduzir custos e aumentar a produtividade, criando um ambiente de trabalho mais saudável e motivado. Ao escolher a nossa empresa de RH, você investe na construção de uma equipe forte, alinhada aos valores da sua empresa, e no sucesso a longo prazo do seu negócio.
                        </p>
                    </div>
